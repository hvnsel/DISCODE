...
EXPRS = [
    "q1ddot = -6.276e+8*q1*q2**2 - 1320.0*q1 - 7.35e+4*q1dot*q2**2 - 1.294*q1dot + 8.262e+7*q2**3 - 1.019e+5*q2**2*q2dot + 2.108e+4*q2**2 + 0.1856*q2dot - 0.01263",
    "q2ddot = 1.084e+8*q1**3 + 1012.0*q1 - 4663.0*q1dot**7 + 876.2*q1dot**5 - 0.04059*q1dot - 1.062e+7*q2**3 - 1704.0*q2 + 3.865e+4*q2dot**9 - 5.266e+4*q2dot**8 - 0.5439*q2dot + 0.06413"
]
