"""
discover_sdof_sim.py
===================

DISCOVER on a **simulated single-DOF** system.  This is the demo script: pick a
...
sanity-check any change to :mod:`discover_core` before touching real data.

Everything is N-DOF underneath; a single DOF is just ``n_dof == 1``, so this
runs the same :func:`discover_train.DISCOVER_TRAIN` loop as the MDOF drivers.
